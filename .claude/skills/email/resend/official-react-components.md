...
**Props:**
- `code` (required) - The actual code to render
- `language` (required) - The language (e.g., "javascript", "python", "typescript")
- `theme` (required) - The theme (import from "@react-email/components": dracula, github, nord, etc.)
- `fontFamily` (optional) - Font family (e.g., "monospace")
...
- Always wrap the `CodeBlock` component in a `div` tag with the `overflow-auto` class
