...
- Client-side validation is not deliverability
...
See [Transactional Emails](./official-transactional-emails.md) for detailed email design guidance.

## Related

- [Compliance](./official-compliance.md) - Legal requirements for consent (GDPR, CASL)
- [Marketing Emails](./official-marketing-emails.md) - What happens after capture
- [Deliverability](./official-deliverability.md) - How validation improves sender reputation
