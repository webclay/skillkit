...
See [official-react-components.md](official-react-components.md) for complete component documentation.
...
React Email supports sending with any email service provider. If the user wants to know how to send, view the [Sending guidelines](official-react-sending.md).
...
See [official-react-i18n.md](official-react-i18n.md) for complete i18n documentation.

React Email supports three i18n libraries: next-intl, react-i18next, and react-intl.

## Email Best Practices

1. **Test across email clients** - Test in Gmail, Outlook, Apple Mail, Yahoo Mail.
...
See [official-react-patterns.md](official-react-patterns.md) for complete examples including:
...
- Component Reference: [official-react-components.md](official-react-components.md)
- Internationalization Guide: [official-react-i18n.md](official-react-i18n.md)
- Common Patterns: [official-react-patterns.md](official-react-patterns.md)
