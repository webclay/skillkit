...
For variable constraints, reserved names, full CRUD examples, pagination, and version history, see [reference.md](https://github.com/resend/resend-skills/blob/main/templates/reference.md).
