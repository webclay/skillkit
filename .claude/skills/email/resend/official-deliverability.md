...
2. List-Unsubscribe header - required by Gmail/Yahoo since Feb 2024 (see [Compliance](./official-compliance.md))
...
- [List Management](./official-list-management.md) - Handle bounces and complaints to protect reputation
- [Sending Reliability](./official-sending-reliability.md) - Retry logic and error handling
