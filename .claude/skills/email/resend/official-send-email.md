...
2. **Install SDK** (preferred) or use cURL - See [references/installation.md](https://github.com/resend/resend-skills/blob/main/send-email/references/installation.md)
...
Always implement these for production email sending. See [references/best-practices.md](https://github.com/resend/resend-skills/blob/main/send-email/references/best-practices.md) for complete implementations.
...
See [references/single-email-examples.md](https://github.com/resend/resend-skills/blob/main/send-email/references/single-email-examples.md) for all SDK implementations with error handling and retry logic.
...
See [references/batch-email-examples.md](https://github.com/resend/resend-skills/blob/main/send-email/references/batch-email-examples.md) for all SDK implementations with validation, error handling, and retry logic.
...
See [references/batch-email-examples.md](https://github.com/resend/resend-skills/blob/main/send-email/references/batch-email-examples.md) for complete chunking implementations.
...
See [references/webhooks.md](https://github.com/resend/resend-skills/blob/main/send-email/references/webhooks.md) for setup, signature verification code, and all event types.
