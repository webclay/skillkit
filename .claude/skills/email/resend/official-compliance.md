...
| GDPR | EU | Explicit opt-in consent | 20M EUR or 4% revenue |
...
- [Email Capture](./official-email-capture.md) - Implement consent forms and double opt-in
- [Marketing Emails](./official-marketing-emails.md) - Consent and unsubscribe requirements
- [List Management](./official-list-management.md) - Handle unsubscribes and deletion requests
