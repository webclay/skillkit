...
- [List Management](./official-list-management.md) - What to do with bounce/complaint data
- [Sending Reliability](./official-sending-reliability.md) - Retry logic when sends fail
