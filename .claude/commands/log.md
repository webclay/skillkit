---
description: Save session progress to changelog and tasks
---

Follow the session-log workflow to save this session's progress.

## Instructions

1. Read `.claude/skills/workflow/session-log/SKILL.md` for the full workflow
